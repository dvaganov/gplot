...
public class Plot.Background : Object
{
...
public class Plot.Curve : Object
{
    private Gdk.RGBA color;
    ...
    public void transform_cb (Gtk.Widget widget, Gdk.EventButton event)
    {
        ...
        if (coords[1,0] - radius_control_point < pointer[0] & pointer[0] < coords[1,0] + radius_control_point &
            coords[1,1] - radius_control_point < pointer[1] & pointer[1] < coords[1,1] + radius_control_point)
        {
        ...
        else if (coords[2,0] - radius_control_point < pointer[0] & pointer[0] < coords[2,0] + radius_control_point &
                 coords[2,1] - radius_control_point < pointer[1] & pointer[1] < coords[2,1] + radius_control_point)
        {
            motion_handler_id = widget.motion_notify_event.connect ((motion_event) =>
            {
